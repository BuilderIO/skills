# /efficient-frontier-opus

Apply the same orchestration as `/efficient-opus` to any high-cost frontier
model.

`/efficient-frontier-opus` is the model-agnostic version of `/efficient-opus`. It
...
```sh
npx @agent-native/skills@latest add --skill efficient-frontier-opus --update-instructions
```
