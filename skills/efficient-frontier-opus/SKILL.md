---
name: efficient-frontier-opus
description: Apply the same orchestration as `/efficient-opus` to any high-cost frontier model: delegate research, coding, and testing to cheaper subagents while keeping planning, synthesis, and final review with the expensive model.
---

# Efficient Frontier (Opus Edition)
...
This is the model-agnostic companion to `/efficient-opus`. While `/efficient-opus`
is tailored to Opus-class models specifically, this skill applies the same
delegation pattern to any high-cost frontier model.
